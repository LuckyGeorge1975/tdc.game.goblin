const unitGuideEntries=[
  {name:'GOBLIN MK III',role:'CYBERNETIC ASSAULT UNIT',team:'FRIENDLY SYSTEM',icon:'G',hp:'SYSTEMS',move:'3 → 0',range:'1–5',attack:'1–6',defense:'BY SYSTEM',copy:'Schwere Cybereinheit mit getrennt angreifbaren Haupt- und Sekundärbatterien, Raketen, AP-Systemen und 45 Ketteneinheiten. Kettenschäden reduzieren die Bewegung stufenweise.'},
